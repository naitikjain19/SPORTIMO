        ...
        <nav style={{ width: "5rem" }} className="hidden md:block fixed left-0 h-screen bg-color4 z-20">
            <div className="flex flex-col items-center" >
                ...
                </SideBarItem>
                {
                    ...
                    </div> : <div onClick={logout}><SideBarItem to="logout"  ><svg className="my-4" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
